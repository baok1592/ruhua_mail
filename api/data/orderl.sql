...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=244 ROW_FORMAT=DYNAMIC COMMENT='商品分类表';
...
CREATE TABLE `rh_favorites` (
  ...
  `ucid` int(1) NOT NULL DEFAULT '3' COMMENT 'ucid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=8192 ROW_FORMAT=DYNAMIC COMMENT='收藏表';
...
#
# Structure for table "rh_fx_goods"
#
...
#
# Data for table "rh_fx_goods"
#


#
# Structure for table "rh_fx_record"
#
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=16554 ROW_FORMAT=COMPACT COMMENT='商品表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=481 ROW_FORMAT=COMPACT COMMENT='商品skui规格价格库存信息表';
...
#
# Structure for table "rh_reduction"
#

DROP TABLE IF EXISTS `rh_reduction`;
CREATE TABLE `rh_reduction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `statu` int(11) NOT NULL COMMENT '是否开启 1开启，2关闭',
  `full` float(11,2) NOT NULL COMMENT '满多少',
  `reduce` float(11,2) DEFAULT NULL COMMENT '减多少',
  `start_time` int(11) DEFAULT NULL COMMENT '开始时间',
  `end_time` int(11) DEFAULT NULL COMMENT '结束时间',
  `created_at` int(11) DEFAULT NULL COMMENT '创建 时间',
...
#
# Data for table "rh_reduction"
#


#
# Structure for table "rh_reduction_goods"
#

DROP TABLE IF EXISTS `rh_reduction_goods`;
...
#
# Data for table "rh_reduction_goods"
#
...
#
# Structure for table "rh_search"
#

DROP TABLE IF EXISTS `rh_search`;
...
CREATE TABLE `rh_sys_config` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=519 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统配置表';

#
# Data for table "rh_sys_config"
#

INSERT INTO `rh_sys_config` VALUES (1,'api_url','','入口位置',1,0,NULL,1595573340,1595573340,3),(2,'web_name','','公众号名称',1,0,NULL,1595662367,1595573340,3),(3,'gzh_appid','','公众号appid',2,0,NULL,1595314101,1595314101,3),(4,'gzh_secret','','公众号秘钥',2,0,NULL,1595314101,1595314101,3),(5,'wx_app_id','','小程序appid',2,0,NULL,1595314101,1595314101,3),(6,'wx_app_secret','','小程序秘钥',2,0,NULL,1595314101,1595314101,3),(7,'pay_num','','商户id',2,0,NULL,1595314101,1595314101,3),(8,'pay_key','','商户key',2,0,NULL,1595314101,1595314101,3),(9,'wx_token_expire','7200','token有效期',1,0,NULL,1595573340,1595573340,3),(21,'exchang_points','1','购物获得积分',1,1,NULL,1595573340,1595573340,3),(22,'use_points','0','积分购物',1,1,NULL,1595573340,1595573340,3),(23,'points_to_money','100','积分1 ： 金额',1,0,'金额：积分=1:100',1595573340,1595573340,3),(24,'money_to_points','1','金额1 ： 积分',1,0,'金额：积分=1:1',1595573340,1595573340,3),(34,'code_url','www.xxxx.com','二维码链接',1,0,NULL,1595573340,1595573340,3),(37,'merge_mode','1','账号关联',1,2,'1微信开放平台关联2手机关联3手机登录',1595573340,1595573340,3),(45,'drive_type','2','配送方式',6,0,'0配送1店内就餐2配送+店内',1593482472,1593482472,3),(57,'feie_user','','飞蛾打印机账号',3,0,NULL,1595312622,1595312622,3),(58,'feie_ukey','','飞蛾打印机ukey',3,0,NULL,1595312622,1595312622,3),(59,'feie_sn','','飞蛾打印机Sn',3,0,NULL,1595312622,1595312622,3),(60,'feie_name','黔域','打印名称',3,0,NULL,1595312622,1595312622,3),(61,'feie_key','','飞蛾打印机key',3,0,NULL,1595312622,1595312622,3),(62,'is_printer','0','是否开启云打印',1,1,NULL,1595573340,1595573340,3),(64,'merchant_name','','商家的店名',6,0,NULL,NULL,NULL,3),(65,'merchan_address','','商家店铺地址',6,0,NULL,NULL,NULL,3),(67,'merchant_brief','附近服务最好，配送最快','店铺简介',6,0,NULL,NULL,NULL,3),(68,'merchant_phonto','0859-1234567','商家电话',6,0,NULL,NULL,NULL,3),(69,'ps_timme','08:00-22:00','配送时间',6,0,NULL,NULL,NULL,3),(70,'shipping_dees','0','配送费',6,0,NULL,NULL,NULL,0),(71,'yzm_sign','','阿里云短信签名',4,0,'',1609381510,1609381510,0),(72,'yzm_keyid','','阿里云短信KeyId',4,0,'',1609381510,1609381510,0),(73,'yzm_secret','','阿里云短信秘钥',4,0,'',1609381510,1609381510,0),(74,'yzm_tmp_id','','验证码模板ID',4,0,'',1609381510,1609381510,0);
...
#
# Structure for table "rh_user_coupon"
#
...
#
# Data for table "rh_user_coupon"
#


#
# Structure for table "rh_user_level"
#

DROP TABLE IF EXISTS `rh_user_level`;
CREATE TABLE `rh_user_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name_l` varchar(255) NOT NULL COMMENT '名称',
...
#
# Structure for table "rh_zhgl"
#

DROP TABLE IF EXISTS `rh_zhgl`;
CREATE TABLE `rh_zhgl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zh_num` varchar(20) NOT NULL COMMENT '桌号',
