...
<div style="width:800px;margin: 100px auto;">
  ...
  外卖点餐安装引导--v<?php echo VAE_VERSION; ?>
  </div>
  <div class="js-box">
    <p>
        欢迎使用外卖点餐系统，采用laravel+VUE开发的三端分离商城系统。<br>
        您在使用中如有任何问题都可以登录 <a href="http://mail.ruhuashop.com/" target="_blank">如花外卖点餐官方网站</a> 获取帮助。<br><br>
        <h3>免费版使用须知：</h3>
      ...
      <h3>免责声明：</h3>
        1、使用如花商城系统构建的程序，任何商品内容、信息内容导致的纠纷和法律争议及后果，如花外卖点餐官方不承担任何责任。<br>
        2、您一旦安装使用外卖点餐系统，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制
