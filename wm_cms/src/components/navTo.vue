		...
		text-color="#fff" active-text-color="#ffd04b" @select="handleSelect"> 
			...
			<el-submenu index="3">
				...
				<el-menu-item-group>
					...
					<el-menu-item index="3-3" @click="jump_list">
						<span slot="title" style="margin-left: 40px;">商家管理</span>
					</el-menu-item>
					<el-menu-item index="3-4" @click="jump_shop_apply">
						<span slot="title" style="margin-left: 40px;">商家申请</span>
					</el-menu-item>
				</el-menu-item-group>
			</el-submenu>
			...
			<el-submenu index="4">
				...
				<el-menu-item-group>
					...
					<el-menu-item index="4-3" @click="jump_yj">
						<span slot="title" style="margin-left: 40px;">佣金记录</span>
					</el-menu-item>
					<el-menu-item index="4-4" @click="jump_reseller_order">
			...
			<el-submenu index="8">
				...
				<el-menu-item-group>
					...
					<el-menu-item index="8-1" @click="jump_tocoupon" v-if="$shop_type!='shops'">
						<span slot="title" style="margin-left: 40px;">优惠券</span>
					</el-menu-item>
					<el-menu-item index="8-2" @click="jump_tovip_tc">
						<span slot="title" style="margin-left: 40px;">商家套餐</span>
					</el-menu-item>
			...
			<el-menu-item index="111" @click="jump_tokong">
