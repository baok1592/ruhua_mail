<template>
	<view class="evaluate">
		...
		<!-- <tui-tabs :tabs="navbar" :currentTab="currentTab>1?0:currentTab" @change="change" itemWidth="50%" selectedColor="#FF7900" sliderBgColor="#FF7900"></tui-tabs> -->
